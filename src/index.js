...
const cxRoutes_1 = __importDefault(require("./routes/cxRoutes"));
const oclRoutes_1 = __importDefault(require("./routes/oclRoutes"));
class Server {
    constructor() {
    ...
    routes() {
        ...
        this.app.use('/api/uni', unidadesRoutes_1.default); //Atendentes
        this.app.use('/api/cx', cxRoutes_1.default); //Caixa
        this.app.use('/api/ocl', oclRoutes_1.default); //Caixa
    }
    start() {
